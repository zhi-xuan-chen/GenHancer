...
class XFluxPipeline:
    def __init__(self, model_type, device, offload: bool = False):
        ...
        self.image_encoder_path = "/group/40034/jasonsjma/models_hf/clip-vit-large-patch14"
        self.hf_lora_collection = "/group/40034/jasonsjma/models_hf/flux-lora-collection"
