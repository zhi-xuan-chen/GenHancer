        ...
        if os.path.isfile(self.data_path):
            ...
            for json_file in json_files:
                with open(json_file, 'r', encoding='utf-8') as f:
                    data.extend(json.load(f)[self.split])
...
def get_chexpert_dataset_and_collator(data_path: str, data_format: str = "csv",
                                  img_size: int = 224, is_train: bool = True,
                                  text_column: str = "findings_section", 
                                  image_column: str = "image_paths",
                                  image_dir: str = None, split: str = "train"):
    ...
    collator = CheXpertDatasetCollator()
...
def loader(train_batch_size: int, num_workers: int, data_path: str, 
    ...
    dataset, collator = get_chexpert_dataset_and_collator(
        data_path=data_path,
        data_format=data_format,
        img_size=img_size,
        is_train=True,
