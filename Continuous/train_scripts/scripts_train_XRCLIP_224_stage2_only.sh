...
accelerate launch --config_file "/home/chenzhixuan/Workspace/GenHancer/Continuous/train_configs/accelerate_config.yaml" --num_processes 4 --main_process_port 29502 /home/chenzhixuan/Workspace/GenHancer/Continuous/train_XRCLIP_stage2_only.py --config "/home/chenzhixuan/Workspace/GenHancer/Continuous/train_configs/combined_dataset_XRCLIP_224_stage2_only.yaml"
