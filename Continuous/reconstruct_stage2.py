...
from clip_models.build_CLIP import load_clip_model_SigLIP, load_clip_model_XRCLIP
...
class XFluxPipeline:
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            inp_cond = prepare_clip(clip=self.clip_vis, original_img=original_img.to(torch.bfloat16), img=x)
...
if __name__ == "__main__":
    ...
    idx = 1
    load_dir = "/jhcnas5/chenzhixuan/checkpoints/GenHancer/outputs/mimic_XRCLIP_224_stage1"
    load_step = 26000
    ...
    clip_vis = load_clip_model_XRCLIP(args, device=device)
